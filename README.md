...
(UPDATE IN README.md)
Meticulously analyzed numerous network traffic data undergoing cyber attacks, using advanced Python techniques and data analysis skills, all within AI4ALL's state-of-the-art Ignite accelerator Program.
...
The difference between benign traffic and cyber attacks are becoming less and less noticeable, with attacks even being able to wait for precious data to be entered into a website unkowningly. With these changes in mind there must be easily accessible software that can determine when an attack is occuring before private information is stolen. This software could be the thing that keeps your data safe.
...
1. Analyzed over a million lines of network data 
*EXAMPLE:*
